...
public class DeviceController {
     ...
     * @return
     */
    @PostMapping("findCustomProperties")
    @ResponseBody
    public Result findCustomProperties(){
        String customProperties = deviceService.findCustomProperties();
        return Result.instanceSuccessResult(customProperties);
    }
