...
import com.thingjs.soho.ConfigBeanProp;
...
public class DeviceServiceImpl implements IDeviceService {
    ...
    @Override
    public String findCustomProperties() {
//        return customProperties;

//        ResourceBundle rb = ResourceBundle.getBundle("application");
//        return rb.getString("custom.prop");

//        return environment.getProperty("custom.prop");
        return environment.getProperty("demo.wife");

//        return configBeanProp.getPhone()+"-"+configBeanProp.getWife();
    }
